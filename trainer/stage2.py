...
def _stage2_b_batch_loss(self, batch) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
    ...
    if use_radius and hasattr(self, "stage2_boundary_radii_v1") and hasattr(self, "stage2_boundary_radii_v2"):
        ...
        fixed_margin = float(getattr(self.config, "stage2_injected_margin", 1.0))
    ...
    loss = (
        ...
        + float(getattr(self.config, "lambda_core_B", 0.5)) * loss_core
        + float(getattr(self.config, "lambda_neg_B", 0.05)) * loss_neg
    )
