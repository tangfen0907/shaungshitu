...
LOCAL_CONFIG_OVERRIDES = {
    # Edit this block directly when you want to tune the SMD experiment.
    ...
    # SMD test split anomaly ratio:
    # raw points = 29444 / 708420 = 4.1563%
    # window flags (seq_len=100, step=1) = 61483 / 708321 = 8.6801%
