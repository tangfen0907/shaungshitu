...
def _export_bank_artifacts(self) -> Dict[str, object]:
    ...
    artifacts = {
        ...
        "cluster_radii_v1": stage2_state.get("cluster_radii_v1"),
        "cluster_radii_v2": stage2_state.get("cluster_radii_v2"),
        "local_radius_v1": stage2_state.get("local_radius_v1"),
        "local_radius_v2": stage2_state.get("local_radius_v2"),
        "local_dist_v1": stage2_state.get("local_dist_v1"),
        "local_dist_v2": stage2_state.get("local_dist_v2"),
